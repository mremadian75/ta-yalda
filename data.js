...
var TA_YALDA = {
  ...
  catLines: {
    mahan: [
      ...
      'وسط کار هم یهو میاد این صفحه رو چک می‌کنه. بله، من دیدم.',
      ...
      'این یکی رو بدون: خیلی به داشتن تو افتخار می‌کنه.',
    ...
    yalda: [
      ...
      'گفت بهت نگم، ولی از الان دلش برای لمس کردنت هم تنگ شده 😌',
  ...
  days: {
    31: {
      ...
      unlock: 'این صفحه رو ساختم چون دلم نمی‌خواست فقط یه عدد کم بشه. می‌خواستم هر روز یه چیز کوچیک از خودم اینجا برات بذارم.',
      unlockKind: 'note'
    },
    30: {
      note: 'دوست دارم خانوم زیبا. یه عالمه هم دوست دارم.',
      unlock: 'کلی به خودم افتخار می‌کنم که تو رو دارم. جدی میگم.',
      unlockKind: 'confession'
    },
    29: {
      note: 'وروجک من، من هنوز نفهمیدم چرا هرچی به اکتبر نزدیک‌تر میشیم به جای آروم شدن بیشتر ذوق می‌کنم.',
    ...
    28: {
      ...
      unlock: 'ممنونم که انقدر خانومی، انقدر همراهی و انقدر منو می‌فهمی ❤️',
      unlockKind: 'note'
    },
    27: {
      note: 'بعضی روزا تا شب سرم توی کاره، ولی حتی همون وسطا هم یهو میای توی ذهنم و کل مودم عوض میشه.',
      unlock: 'اگه یه وقت دیر جواب دادم یا حواسم پرت بود، معنی‌ش این نیست که حواسم به تو نیست. برعکس.',
      unlockKind: 'confession'
    },
    26: {
    ...
    25: {
      ...
      unlock: 'یه عالمه حرف دارم که تایپ کردنشون اصلاً مثل گفتنشون نیست. بعضیاشون رو نگه داشتم برای وقتی جلوی خودمی.',
      unlockKind: 'note'
    },
    24: {
    ...
    23: {
      note: 'یلدا تو خیلی قشنگی. اینو می‌دونی. ولی چیزی که من بیشتر دوست دارم اخلاق خوبت، طرز فکرت، رفتارت و مهربونیت هست.',
      unlock: 'من واقعاً با تمام وجود از خیلی از خصوصیاتت خوشم میاد. فقط ظاهر نیست، اصلاً.',
      unlockKind: 'confession'
    },
    22: {
      note: 'دوست دارم وروجک. خیلی.',
      unlock: 'امروز هیچ متن شاعرانه‌ای ندارم. فقط دلم برات تنگ شده و دوستت دارم.',
      unlockKind: 'note'
    },
    21: {
      note: 'من از اون آدمایی نیستم که هر روز یه متن قشنگ و شاعرانه بنویسم. ولی اینو خیلی راحت می‌تونم بگم: خیلی خوشحالم تو رو دارم.',
    ...
    20: {
      ...
      unlock: 'دو تا مسیر جدا، دو تا پرواز و آخرش من و تو. این قسمت آخرش رو بیشتر دوست دارم.',
      unlockKind: 'plan'
    },
    19: {
    ...
    18: {
      ...
      unlock: 'من حواسم به خیلی از چیزای کوچیکی که برای من می‌کنی هست. هیچکدومش برام عادی نشده.',
      unlockKind: 'confession'
    },
    17: {
      note: 'هرچی نزدیک‌تر میشیم بیشتر ذوق می‌کنم. فکر می‌کردم برعکسش آروم‌تر میشم. نشدم.',
      unlock: 'احتمالاً تا اون روز صد بار دیگه هم میگم خیلی خوشحالم قراره ببینمت. تحمل کن 😌',
      unlockKind: 'joke'
    },
    16: {
      note: 'دوست دارم یه عالمه خانوم زیبا.',
      unlock: 'و بله، هنوزم از گفتنش خسته نشدم. احتمالاً هم نمی‌شم.',
      unlockKind: 'note'
    },
    15: {
    ...
    12: {
      ...
      unlock: 'مرسی که هستی کوچولوی من. مرسی که کنارمی و می‌فهمیم همدیگه رو.',
      unlockKind: 'note'
    },
    11: {
      note: 'زیباترین و قشنگ‌ترین و مهربون‌ترین خانوم من.',
      unlock: 'یه چیز خصوصی‌تر: دلم برای لمس کردنت هم خیلی تنگ شده. خیلی.',
      unlockKind: 'private'
    },
    10: {
      note: 'ده روز. یعنی دیگه عددش دو رقمی هم به زور مونده.',
      unlock: 'من از الان دارم اون لحظه‌ای که می‌بینمت رو توی سرم هزار مدل تصور می‌کنم. هیچکدومش به اندازه واقعیش خوب نیست.',
      unlockKind: 'confession'
    },
    9: {
      note: 'دوست دارم فرشته کوچولوی من.',
      unlock: 'اگه الان پیشم بودی احتمالاً فقط می‌کشیدمت بغلم، می‌بوسیدمت و یه مدت اصلاً نمی‌ذاشتم بری.',
      unlockKind: 'private'
    },
    8: {
      note: 'یلدا، خیلی دوست دارم که انقدر همراهی و می‌تونم باهات حرف بزنم. واقعاً حس خوبی بهم میدی.',
      unlock: 'این یکی از چیزاییه که شاید کم بگم ولی خیلی برام مهمه. کنار تو لازم نیست نقش بازی کنم.',
      unlockKind: 'note'
    },
    7: {
    ...
    6: {
      ...
      unlock: 'یه عالمه بوس و بغل طلب دارم. و نه، فکر نکن فقط بغل 😌',
      unlockKind: 'private'
    },
    5: {
      note: 'پنج روز. من رسماً دیگه صبر ندارم.',
      unlock: 'اگه روز دیدنت زیادی محکم بغلت کردم اعتراض وارد نیست. خیلی وقته طلبکارم.',
      unlockKind: 'joke'
    },
    4: {
      note: 'چهار روز مونده کوچولو. فقط چهار تا خواب.',
      unlock: 'فکر کنم اولین چیزی که میگم یه چیز کاملاً معمولی و احمقانه باشه چون مغزم کار نمی‌کنه. بعدش احتمالاً فقط می‌بوسمت.',
      unlockKind: 'private'
    },
    3: {
    ...
    2: {
      ...
      unlock: 'اون شبی که خودت بخوای، دوست دارم ببندمت به تخت، دستا و پاهات رو نتونی تکون بدی و فقط حس کنی دارم می‌خورمت و می‌کنمت.',
      unlockKind: 'private'
    },
    1: {
      note: 'فردا. بالاخره فردا می‌بینمت خانوم زیبا ❤️',
      unlock: 'امشب زود بخواب کوچولو. فردا یه عالمه کار باهات دارم. از بغل کردن شروع میشه، ولی همونجا تموم نمیشه 😌',
      unlockKind: 'private'
    },
    0: {
      note: 'امروز می‌بینمت یلدا. خیلی خیلی دوست دارم. راه بیفت بیا که دیگه واقعاً صبر ندارم ❤️',
      unlock: 'وقتی رسیدی فقط بیا بیرون. من اونجام. بقیه‌ش با خودم.',
      unlockKind: 'promise'
    }
  },
...
/* متن های ثابت صفحه هم شخصی میشن، بدون اینکه منطق روزشمار دست بخوره. */
if (typeof document !== 'undefined') {
  (function () {
    ...
    function personalizePage() {
      ...
      text('.route-foot', 'تو از ساری، من از مادرید، آخرش همدیگه رو بغل می‌کنیم ❤️');
      text('.today .section-title', 'امروز می‌خواستم اینو بهت بگم');
      text('.unlocks .section-title', 'یه چیز کوچولو فقط برای تو');
      text('.cities .section-title', 'الان');
      ...
      text('.flight .section-note', '۱۴ اکتبر، ۱۰:۴۵. این ساعت رو دیگه از حفظ شدم.');
      text('.foot-line', 'دوست دارم کوچولوی من ❤️');
      text('.song .section-title', 'آهنگ امروز برای تو');
